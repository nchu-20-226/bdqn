    ...
    <head>
        ...
        <script type="application/javascript">
            ...
            function fillEmployees() {
                ...
                $.get("/queryAllBydepId?depId="+departmentid,function (data) {
                    ...
                    <fieldset>
                        ...
                        <table class="formtable">
                            ...
                            <tr>
                                <td>预计开始时间：</td>
                                <td>
                                    <input type="text" name="starttime" class="Wdate" id="starttime" onclick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'})">
                                </td>
                            </tr>
                            <tr>
                                <td>预计结束时间：</td>
                                <td>
                                    <input type="text" name="endtime" class="Wdate" id="endtime" onclick="WdatePicker({dateFmt: 'yyyy-MM-dd HH:mm:ss'})">
                                </td>
                            </tr>
							<tr>
                                <td>会议室名称：</td>
